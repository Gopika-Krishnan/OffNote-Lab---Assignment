...
class Config:
    ...
    base_log_dir: str = '/content/itr/itr/logs/'
    base_output_dir: str = '/content/itr/itr/output/'
    ...
    def __post_init__(self):
        self.log_dir = Path(self.base_log_dir) 
        #/ self.exp_name
...
hc1 = Config(data='/content/itr/itr/data/hin-eng/',
                    exp_name='default',
                    lang='hi',
                )
